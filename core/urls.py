...
urlpatterns = [
    ...
    path('admin-panel/branding/update/', views.update_branding_assets, name='update_branding_assets'),
    ...
    path('services/catalog/', views.services_page, name='services_catalog'),
